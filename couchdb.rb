...
class Couchdb < Formula
  ...
  url 'https://dist.apache.org/repos/dist/dev/couchdb/source/1.4.0/rc.1/apache-couchdb-1.4.0.tar.gz'
  ...
  if build.devel? or build.head?
    ...
    # CouchDB >= 1.4.0 requires autoconf 2.63 or higher
  ...
  def install
    # couchdb 1.4.0 supports vendor names and versioning
